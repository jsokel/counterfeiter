...
import (
	...
	"github.com/jsokel/counterfeiter/v6/arguments"
	"github.com/jsokel/counterfeiter/v6/command"
...
func run() error {
	...
	for i := range invocations {
		...
		// '//go:generate go run github.com/jsokel/counterfeiter/v6 -generate -header /some/header.txt'
