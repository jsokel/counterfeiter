	...
	when("manually constructing a fake", func() {
		...
		when("duplicate import package names are added", func() {
			it.Before(func() {
				...
				f.Imports.Add("sync", "github.com/jsokel/counterfeiter/v6/fixtures/sync")
				f.Imports.Add("sync", "github.com/jsokel/counterfeiter/v6/fixtures/othersync")
			})
			...
			it("all packages have unique aliases", func() {
				Expect(f.Imports).To(BeEquivalentTo(Imports{
					ByAlias: map[string]Import{
						"sync":  {Alias: "sync", PkgPath: "sync"},
						"synca": {Alias: "synca", PkgPath: "github.com/jsokel/counterfeiter/v6/fixtures/sync"},
						"syncb": {Alias: "syncb", PkgPath: "github.com/jsokel/counterfeiter/v6/fixtures/othersync"},
					},
					ByPkgPath: map[string]Import{
						"sync": {Alias: "sync", PkgPath: "sync"},
						"github.com/jsokel/counterfeiter/v6/fixtures/sync":      {Alias: "synca", PkgPath: "github.com/jsokel/counterfeiter/v6/fixtures/sync"},
						"github.com/jsokel/counterfeiter/v6/fixtures/othersync": {Alias: "syncb", PkgPath: "github.com/jsokel/counterfeiter/v6/fixtures/othersync"},
					},
				}))
			})
		})
		...
		when("working with imports", func() {
			when("there are no imports", func() {
				...
				it("turns a vendor path into the correct import", func() {
					i := f.Imports.Add("apackage", "github.com/jsokel/counterfeiter/v6/fixtures/vendored/vendor/apackage")
