...
//counterfeiter:generate -p github.com/jsokel/counterfeiter/v6/fixtures/packagemode
//counterfeiter:generate -o flagcustomfakesdir -p github.com/jsokel/counterfeiter/v6/fixtures/packagemode
